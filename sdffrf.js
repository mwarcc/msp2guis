...
class FetchInterceptor {
  ...
  intercept() {
      ...
      window.fetch = async function (...args) {
          ...
          // Check if the URL exactly matches the one we want to redirect
          if (typeof url === 'string') {
              // Redirect specific URL
              if (url === 'https://moviestarplanet2.fr/img/main-bg.jpg') {
                  console.log('Redirecting to new image...');
                  return self.originalFetch('https://images3.alphacoders.com/118/1181423.jpg', options);
              }

              // Proceed with URL transformation if enabled and applicable
          ...
          // Default fetch behavior if no other condition matches
