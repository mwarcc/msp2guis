...
/* harmony import */ var _TokenService_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TokenService.js */ "./src/services/TokenService.js");
/* harmony import */ var _AnalyticsService_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AnalyticsService.js */ "./src/services/AnalyticsService.js");
/* harmony import */ var _SecurityService_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SecurityService.js */ "./src/services/SecurityService.js");
...
class MSP2Client {
    ...
    constructor() {
        this.#analytics = _AnalyticsService_js__WEBPACK_IMPORTED_MODULE_1__.AnalyticsService.getInstance();
        this.#security = _SecurityService_js__WEBPACK_IMPORTED_MODULE_2__.SecurityService.getInstance();
        this.initialize();
    }
    ...
    async resetAvatar() {
        try {
            ...
            const avatarResponse = await fetch(
                ...
                { 
                    headers: this.#security.getHeaders(token)
                }
            );
            ...
            const updateResponse = await fetch(
                `https://eu.mspapis.com/profilegeneratedcontent/v2/profiles/${profileId}/games/j68d/avatars/${avatarData.avatarId}`,
                {
                    method: 'PUT',
                    headers: {
                        ...this.#security.getHeaders(token),
...
/* harmony export */ });
/**
 * Service for handling security and anti-tracking functionality
 */
class SecurityService {
    #blockedDomains = [
        'google-analytics.com',
        'analytics.eu.moviestarplanet.app',
    ];
    static #instance;
    ...
    /**
     * Get singleton instance
     * @returns {SecurityService} Singleton instance
     */
    static getInstance() {
        if (!SecurityService.#instance) {
    ...
    isBlocked(url) {
        try {
            ...
            return this.#blockedDomains.some(domain => urlObj.hostname.includes(domain));
        } catch {
            return false;
        }
    }
    ...
    interceptXHR() {
        ...
        XMLHttpRequest.prototype.open = function(method, url, ...args) {
            if (self.isBlocked(url)) {
                console.log(`[SecurityService] Blocked XHR request to ${url}`);
                this.abort();
                return;
            }
    ...
    interceptFetch() {
        ...
        window.fetch = function(resource, init) {
            ...
            if (self.isBlocked(url)) {
                console.log(`[SecurityService] Blocked fetch request to ${url}`);
                return new Promise(() => {});
            }
...
/* harmony import */ var _services_SecurityService_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/SecurityService.js */ "./src/services/SecurityService.js");
...
const security = _services_SecurityService_js__WEBPACK_IMPORTED_MODULE_6__.SecurityService.getInstance();
...
window.fetch = async function (url, options) {
    if (url.includes('/games/j68d/rewards/daily_pickup') && !isRequestBeingRepeated) {
        ...
        for (let i = 0; i < 4; i++) {
            await security.delay();
            await originalFetch(url, {
                ...options,
                headers: security.getHeaders(options?.headers?.authorization)
            });
        }
