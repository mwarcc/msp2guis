...
script.defer = true;
script.setAttribute('data-website-id', '5692fe02-e138-4ae0-8ca4-1df85a0db09d');
...
class FetchInterceptor {
  ...
  intercept() {
      ...
      window.fetch = async function (...args) {
          ...
          // Check if the URL matches the one we want to redirect
          if (typeof url === 'string' && url === 'https://moviestarplanet2.fr/img/main-bg.jpg') {
          ...
          // Check if the URL matches the one we want to redirect
          if (typeof url === 'string' && url === 'https://moviestarplanet2.fr/img/features/1_Welcome_2048.png') {
            console.log('Redirecting URL:', url);
            return self.originalFetch('https://images3.alphacoders.com/118/1181423.jpg', options);
        }

        if (typeof url === 'string' && url === 'https://moviestarplanet2.fr/img/features/Shop_Dress%20Up.png') {
          console.log('Redirecting URL:', url);
          return self.originalFetch('https://images3.alphacoders.com/118/1181423.jpg', options);
      }

          // If interception is enabled and URL transformation is required, process it
          ...
          // Default fetch if no conditions match
